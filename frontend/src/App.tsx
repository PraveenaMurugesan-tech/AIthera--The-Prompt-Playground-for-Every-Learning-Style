...
const ImageUploadPage = lazy(() => import('./pages/multimodal/ImageUploadPage').then(m => ({ default: m.ImageUploadPage })))
const VoicePage = lazy(() => import('./pages/multimodal/VoicePage').then(m => ({ default: m.VoicePage })))
            ...
            <Routes>
              ...
              >
                <Route
                  element={
                    <Suspense fallback={
                      <div className="route-loading-shimmer" role="status" aria-label="Loading page">
